...
# Features: SUPPORT_PIONEER is defined in media_player.py to avoid importing
# homeassistant.components.media_player here (config_flow imports const and
# must load without loading the media_player platform).
